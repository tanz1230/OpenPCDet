...
class V2V4RealteslaDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.split = self.dataset_cfg.DATA_SPLIT[self.mode] #self.mode inherent from DatasetTemplate self.mode = 'train' if training else 'test'
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            class_names=['Vehicle'],
            data_path=Path("/home/idiot/OpenPCDet/data/V2V4Real_tesla"),
            save_path=Path("/home/idiot/OpenPCDet/data/V2V4Real_tesla"),
        )
