...
class V2XRealDataset(DatasetTemplate):
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            data_path=Path("/home/idiot/OpenPCDet/data/V2XReal"),
            save_path=Path("/home/idiot/OpenPCDet/data/V2XReal"),
        )
